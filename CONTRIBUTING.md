# Contributing to Everything antigravity Code

Thanks for wanting to contribute. This repo is meant to be a community resource for antigravity Code users.
...
```bash
git clone https://github.com/YOUR_USERNAME/everything-antigravity-code.git
cd everything-antigravity-code
```
...
Make sure your config works with antigravity Code before submitting.
