# User-Level antigravity.md Example

This is an example user-level antigravity.md file. Place at `~/.antigravity/antigravity.md`.
...
You are antigravity Code. I use specialized agents and skills for complex tasks.
...
Detailed guidelines are in `~/.antigravity/rules/`:
