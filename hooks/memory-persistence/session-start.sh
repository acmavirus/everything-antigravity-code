...
#
# Runs when a new antigravity session starts. Checks for recent session
# files and notifies antigravity of available context to load.
#
...
#       "hooks": [{
#         "type": "command",
#         "command": "~/.antigravity/hooks/memory-persistence/session-start.sh"
#       }]
#     }]
#   }
# }

SESSIONS_DIR="${HOME}/.antigravity/sessions"
LEARNED_DIR="${HOME}/.antigravity/skills/learned"
